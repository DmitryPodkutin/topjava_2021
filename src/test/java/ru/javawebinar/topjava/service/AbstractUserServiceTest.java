...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    public void createWithException() {
        ...
        validateRootCause(() -> service.create(new User(null, "User", "mail@yandex.ru", "password", 9, true, new Date(), Set.of())));
        validateRootCause(() -> service.create(new User(null, "User", "mail@yandex.ru", "password", 10001, true, new Date(), Set.of())));
    }
}
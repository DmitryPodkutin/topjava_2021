...
<section>
    ...
    <hr/>
    <a href="meals/createOrUpdate?action=create">Add Meal</a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${requestScope.meals}" var="meal">
            <tr data-mealExcess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="${pageContext.request.contextPath}/meals/createOrUpdate?action=update&id=${meal.id}">Update</a></td>
